...
<body id="page-top"> 
      		...
      		<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
            			<h1 class="h3 mb-0 text-gray-800">NPP Unit</h1>
					...
					<div class="card mb-3">
						<div class="card-header">
							<a href="#formunit" data-toggle="modal" class="btn btn-green" onclick="submit('add',null)"><i class="fas fa-plus"></i> Add New</a>
							<!--<a href="#" class="btn btn-orange" onclick="ResetTable()"><i class="fas fa-refresh"></i>Refresh</a>-->
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table id="myUnit" class="table table-striped table-bordered table-sm " cellspacing="0" width="100%">
							...
							<!--Modal ADD & Edit-->
							<div class="modal fade" id="formunit" tabindex="-1" role="dialog">
       							<div class="modal-dialog modal-xl">
            						<div class="modal-content">
                						...
                						<div class="modal-body form" >
											...
											<div class="form-group row" id="unit">
                            					<label class="col-md-2 col-form-label">Divisi</label>
                            					<div class="col-md-10">
                                                    <select id="divisi" class="pc form-control">
  ...
  <?php $this->load->view('script/Unit_Script');?>
